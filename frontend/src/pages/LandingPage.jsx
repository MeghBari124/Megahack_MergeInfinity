    ...
    return (
        <section className="relative min-h-[95vh] flex items-center overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
                ...
                >
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 dark:text-white mb-6 leading-tight tracking-tight">
                        Your Land. <br />
                        <span className="text-green-400">Your Legacy.</span>
                    </h1>

                    <p className="text-lg sm:text-xl text-slate-700 dark:text-slate-300 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
